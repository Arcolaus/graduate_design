...
class CeleWorksDetailSpider(scrapy.Spider):
	name = "cele_works_detail"
	allowed_domains = ["movie.douban.com"]
	# start_urls = ["https://movie.douban.com/subject/1292213/"]

	custom_settings={
		'ITEM_PIPELINES': {'scrapy_data.pipelines.ExportCeleWorksDetail': 300,},
	}

	def start_requests(self):
		self.movie_list=pd.read_csv('cele_works.csv')
