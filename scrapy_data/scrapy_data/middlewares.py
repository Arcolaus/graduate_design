...
class ScrapyDataDownloaderMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        ua=UserAgent()
        request.meta["User-Agent"]=ua.edge
